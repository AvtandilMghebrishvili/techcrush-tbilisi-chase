...
import { secretOpen } from "./event-rules.js";
export const CITY_IDS = ["tbilisi", "kutaisi", "batumi", "rustavi"];
const requested =
...
export const IS_RUSTAVI = ACTIVE_MAP === "rustavi";
...
export const mapUnlocked = (profile, map, now) =>
  CITY_IDS.includes(map) && (map !== "rustavi" || secretOpen(profile, now));
